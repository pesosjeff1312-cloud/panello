...
export type Tx = { id: string; user_id: string; date: string; descr: string; amount: number; cat: string | null; created_at: string }
...
export type Exercise = { id: string; user_id: string; text: string; detail: string; position: number; archived: boolean }
